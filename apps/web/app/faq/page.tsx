...
const GENERAL_FAQS: readonly FaqItem[] = [
  {
    id: "cosa-e-hagenton",
...
const INSTRUMENT_FAQS: readonly FaqItem[] = [
  {
...
const DATA_FAQS: readonly FaqItem[] = [
  {
    id: "dati-al-sicuro",
...
const DISCLAIMER_FAQS: readonly FaqItem[] = [
  {
 ...
 * chiuso e la risposta non è visibile.
 */
